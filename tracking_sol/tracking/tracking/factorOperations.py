...
def joinFactors(factors: List[Factor]):
    ...
    joinedFactor = Factor(unconditionedVariables, conditionedVariables, factors[0].variableDomainsDict())
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for assignmentDict in eliminatedFactor.getAllPossibleAssignmentDicts():
            ...
            for value in factor.variableDomainsDict()[eliminationVariable]:
                ...
                fullAssignmentDict[eliminationVariable] = value
                probability += factor.getProbability(fullAssignmentDict)
