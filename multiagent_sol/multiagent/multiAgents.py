...
def betterEvaluationFunction(currentGameState: GameState):
    ...
    DESCRIPTION: Combines the game score with incentives for fewer remaining
    foods and capsules, closeness to the nearest food and capsule, pressure to
    avoid active ghosts, and incentive to chase scared ghosts when safe.
    """
    ...
    if capsules:
        ...
        score += 3.0 / (min(capsuleDistances) + 1)
